...
C=read.table("/data/GI-Informatics/DePasquale/Projects/SpatialDoublet/Testing_tools/Scrublet/Scrublet_Synth/Synth/results_df.csv", sep=",", header=T)
...
pdf(file = "/data/GI-Informatics/DePasquale/Projects/SpatialDoublet/Testing_tools/Scrublet/Scrublet_Synth/Scrublet_Synth_curve.pdf", width = 10, height = 10)
par(mar=c(4, 4, 4, 4))
  basicplot
dev.off()
